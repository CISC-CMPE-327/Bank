...
If only two of the numbers are the same, then it outputs 1, and if no two are the same then it outputs 8. 
...
Problem ID b'eCA9PSAxLCYmLHkgPT0gOTUsbSA8IDI0LHx8LG4gPCA1NCw1LDMsNSwwLDEsOCw3'.
